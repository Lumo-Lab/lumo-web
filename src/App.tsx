...
const blogs=[
  {id:"b1",title:"Nomo Smart Care: Case Study",cat:"Case Study",date:"April 8, 2025",read:"6 min",author:"Jurica Mlinaric",authorImg:"/images/jurica.png",cover:"linear-gradient(135deg,#002840 0%,#004C73 50%,#0a7ea4 100%)",headerImg:"/images/nomo_header.png",excerpt:"How we built a full-stack AI-powered elder care platform — from edge audio models to native mobile apps.",body:[
  ...
  {id:"b2",title:"Deep Learning for Audio Classification",cat:"Engineering",date:"March 11, 2025",read:"8 min",author:"Matija Sever",cover:"linear-gradient(135deg,#1a0533 0%,#3b0764 50%,#6d28d9 100%)",headerImg:"/images/blog_2.jpg",excerpt:"How convolutional neural networks learn to hear — and why spectrograms are the secret ingredient.",body:[
  ...
  {id:"b3",title:"AI on Microcontrollers",cat:"Engineering",date:"November 20, 2024",read:"7 min",author:"Rudolf Lovrencic",cover:"linear-gradient(135deg,#062a1a 0%,#065f46 50%,#059669 100%)",headerImg:"/images/blog_1.jpg",excerpt:"Running deep learning models on ESP32 microcontrollers — why it's harder than it sounds, and how we made it work.",body:[
              ...
              {tests.map((t,i)=><div key={i} style={{minWidth:"100%",padding:"0 8px"}}>
                <div style={{background:"#fff",borderRadius:16,padding:"36px 44px",border:"1px solid var(--brd)",boxShadow:"0 4px 24px rgba(0,30,50,.04)",textAlign:"center"}}>
                  ...
                  <div style={{display:"flex",alignItems:"center",gap:14,justifyContent:"center"}}>
                    <img src={(t as any).img||"/images/default_user.png"} alt={t.n} onError={(e)=>{(e.target as HTMLImageElement).src="/images/default_user.png";}} style={{width:64,height:64,borderRadius:"50%",objectFit:"cover",objectPosition:"top",flexShrink:0,border:"2px solid var(--brd)"}}/>
      ...
      <div style={{maxWidth:680,margin:"0 auto"}}>
        <div style={{transform:"translateY(-28px)",background:"#fff",borderRadius:16,padding:"32px 36px",boxShadow:"0 4px 24px rgba(0,30,50,.06)",border:"1px solid var(--brd)"}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:12,paddingBottom:24,borderBottom:"1px solid var(--brd)",marginBottom:28}}>
            <img src={ac.authorImg||"/images/default_user.png"} alt={ac.author} onError={(e)=>{(e.target as HTMLImageElement).src="/images/default_user.png";}} style={{width:36,height:36,borderRadius:"50%",objectFit:"cover",objectPosition:"top"}}/>
            <div>
      ...
      {fil.map(p=><div key={p.id} className="er" onClick={()=>go("blog",p.id)} style={{cursor:"pointer",display:"flex",gap:32,alignItems:"flex-start"}}>
        ...
        <div style={{flex:1,minWidth:0,paddingTop:4}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:8}}>
            <img src={p.authorImg||"/images/default_user.png"} alt={p.author} onError={(e)=>{(e.target as HTMLImageElement).src="/images/default_user.png";}} style={{width:26,height:26,borderRadius:"50%",objectFit:"cover",objectPosition:"top"}}/>
